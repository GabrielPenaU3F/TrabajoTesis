...
tiempo = 10; %Segundos
potencia = 8; %Watts
x = generar_ruido_blanco_gaussiano(10, fs, potencia);
...
recordblocking(audio_recorder, tiempo); %Grabo por tantos segundos como dure la señal y bloqueo el programa
