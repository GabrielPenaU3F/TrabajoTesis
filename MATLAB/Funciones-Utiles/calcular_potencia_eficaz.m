...
function valor_eficaz = calcular_potencia_eficaz(data, Ts, t_comienzo, periodo) 
    ...
    elseif (periodo < Ts)
        ...
        valor_eficaz = 0; 
        %{
            Este return está porque en el cálculo de la envolvente
            energética, puede pedirse integrar sobre un período menor al 
            período de muestreo. En dicho caso, efectivamente no se agrega
            energía ninguna en dicho período de integración.
        %}
    else
